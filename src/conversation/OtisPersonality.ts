...
export class OtisPersonality {
  ...
  private analyzeUserState(userMessage: string): {
      ...
      const energyLevel =
          ...
          energyKeywords.low.some((k) => lower.includes(k)) ||
      ...
      const emotionalTone = emotionalKeywords.stressed.some((k) =>
  ...
  private greetReturningUser(): string {
      ...
      const greetings = [
              ...
              "Morning. How is your body feeling?"
  ...
  private respondToLowEnergy(tone: string): string {
      ...
      return tone === "stressed"
        ...
        ? "You need to slow down. What would help right now?"

              : "Rest is good. Your body might appreciate some gentle movement though.";
